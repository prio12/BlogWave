...
const SignUp = () => {
  ...
  <div>
    <h3 className="text-2xl text-center font-semibold my-12">Sign up with email</h3>
    ...
    <Link to="/signUpMethods" className="flex justify-center">
      <p>
        <small className="flex items-center gap-2">
          <BsChevronLeft /> <span className="text-green-600 font-semibold">All sign up options</span>
        </small>
      </p>
    </Link>
  </div>
