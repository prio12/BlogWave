  ...
  return (
    <div className="mt-16 py-24 relative m-5 md:w-1/2 md:mx-auto  border-[1px]">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-sm text-center mt-16">Click “Sign Up” to agree to BlogWave's Terms of Service and acknowledge <br />
        that BlogWave's Privacy Policy applies to you.</p>
      </div>
    </div>
  );
};
